...
<body>
    ...
    <div class="side-menu__block">
        ...
        <div class="side-menu__block-inner ">
            <div class="side-menu__top justify-content-end">
                ...
                <a href="#" class="side-menu__toggler side-menu__close-btn"><img src="frontend/assets/images/close.png" alt=""></a>
            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="navigation">
                            <nav class="navbar navbar-expand-lg navbar-light ">
                                <a class="navbar-brand" href="index.html"><img src="/images/admin logo.png" alt=""></a> 

                                <a class="navbar-brand-2" href="index.html"><img src="/images/admin logo.png" alt=""></a> 
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-7">
                        <div class="banner-content">
                            <h1 class="title">India’s No. 1 Bulk SMS Platform</h1>
                            <p>Increase sales and customer satisfaction with smarter SMS campaigns, instant OTPs, notifications, two-way interactions, and other award-winning bulk SMS services.</p>
                            <a class="main-btn" href="/">Start Now</a>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-5">
                        <div class="banner-thumb text-right wow fadeInUp" data-wow-duration="1500ms">
                            <img src="images/illus2.jpg" alt="banner">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-9">
                    <div class="section-title text-center">
                        <span>India’s No. 1 Bulk SMS Platform</span>
                        <h3 class="title"></h3>
                    </div>
                </div>
            </div>
                    ...
                    <div class="features-btn">
                        <ul class="nav nav-pills d-flex justify-content-between" id="pills-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active text-center" id="pills-1-tab" data-toggle="pill" href="#pills-1" role="tab" aria-controls="pills-1" aria-selected="true">
                                    <i class="flaticon-responsive"><img src="frontend/assets/images/features-shape.png" alt="shape"></i>
                                    <span>Free Setup</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="pills-2-tab" data-toggle="pill" href="#pills-2" role="tab" aria-controls="pills-2" aria-selected="false">
                                    <i class="flaticon-computer-graphic"><img src="frontend/assets/images/features-shape.png" alt="shape"></i>
                                    <span>Quick Access</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="pills-3-tab" data-toggle="pill" href="#pills-3" role="tab" aria-controls="pills-3" aria-selected="false">
                                    <i class="flaticon-seo-and-web"><img src="frontend/assets/images/features-shape.png" alt="shape"></i>
                                    <span>Manage Users</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="pills-4-tab" data-toggle="pill" href="#pills-4" role="tab" aria-controls="pills-4" aria-selected="false">
                                    <i class="flaticon-development"><img src="frontend/assets/images/features-shape.png" alt="shape"></i>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="pills-5-tab" data-toggle="pill" href="#pills-5" role="tab" aria-controls="pills-5" aria-selected="false">
                                    <i class="flaticon-app-development"><img src="frontend/assets/images/features-shape.png" alt="shape"></i>
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-1" role="tabpanel" aria-labelledby="pills-1-tab">
                                ...
                                <h4 class="title">Better Deliver</h4>
                                <p>No one can deliver better than us. With way2sms, Industry’s best quality SMS delivery guaranteed. Over 12 years of SMSing experience and served over 5 crore audience. Delivered over 100 Billion messages till date.</p>
                            </div>
                            ...
                            <div class="tab-pane fade" id="pills-3" role="tabpanel" aria-labelledby="pills-3-tab">
                                ...
                                <h4 class="title">Our Support consultants</h4>
                                <p>Our Support consultants and Mobile marketing experts are always at hand to help you or your business to run campaigns that can deliver best results. We assure best quality and superior support to all our customers, irrespective of your budget.</p>
                            </div>
                            <div class="tab-pane fade" id="pills-4" role="tabpanel" aria-labelledby="pills-4-tab">
                                <i class="flaticon-development"></i>
                                <h4 class="title">Speed of SMS</h4>
                                <p>We are known for our speed of SMS delivery. We deliver over 90% SMSes with in 10 Sec. Our partnerships with multiple operators from over a decade helped us to build Intelligent, carrier grade SMS gateway with robust infrastructure.</p>
                            </div>
    ...
    <section class="about-area pb-100">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="about-thumb  wow fadeInLeft" data-wow-duration="1500ms">
                        <img src="frontend/assets/images/about-thumb.png" alt="">
                        <div class="about-thumb-1">
                            <img src="frontend/assets/images/about-item-1.png" alt="">
                        </div>
                        <div class="about-thumb-2">
                            <img src="frontend/assets/images/about-item-2.png" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="about-content">
                        ...
                        <a class="main-btn mt-50" href="/">Start Now</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="about-shape-2">
            <img src="frontend/assets/images/about-shape.png" alt="shape">
        </div>
    </section>
            ...
            <div class="row brand-active">
                <div class="col-lg-3">
                    <div class="brand-item">
                        <a href="#"><img src="frontend/assets/images/brand.png" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="brand-item">
    ...
    <section class="business-area pt-110 pb-120">
        ...
        <div class="business-thumb text-right">
            <img src="frontend/assets/images/business-thumb.jpg" alt="">
        </div>
    ...
    <section class="customers-area pt-120 pb-120">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="customers-thumb wow fadeInLeft" data-wow-duration="1500ms">
                        <img src="frontend/assets/images/customers-thumb.png" alt="customers">
                    </div>
                </div>
        ...
        <div class="customers-shape text-right">
            <img src="frontend/assets/images/customers-shape.png" alt="shape">
        </div>
        <div class="customers-shape-1"></div>
    </section>

    <div class="video-play-area bg_cover" style="background-image: url(assets/images/video-play-bg.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
    ...
    <section id="testimonials" class="testimonials-area bg_cover pt-120 pb-120" style="background-image: url(assets/images/testimonials-bg.jpg);">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-9">
                    <div class="testimonials-user-item">
                        <div class="testimonials-thumb pl-110">
                            <div class="item">
                                <img src="frontend/assets/images/testimonials-user-1.png" alt="">
                            </div>
                            <div class="item">
                                <img src="frontend/assets/images/testimonials-user-2.png" alt="">
                            </div>
                            <div class="item">
                                <img src="frontend/assets/images/testimonials-user-3.png" alt="">
                            </div>
                        </div>
                        <div class="testimonials-user">
                            <div class="item-1">
                                <img src="frontend/assets/images/testimonials/user-1.png" alt="testimonials">
                            </div>
                            <div class="item-2">
                                <img src="frontend/assets/images/testimonials/user-2.png" alt="testimonials">
                            </div>
                            <div class="item-3">
                                <img src="frontend/assets/images/testimonials/user-3.png" alt="testimonials">
                            </div>
                            <div class="item-4">
                                <img src="frontend/assets/images/testimonials/user-4.png" alt="testimonials">
                            </div>
                            <div class="item-5">
                                <img src="frontend/assets/images/testimonials/user-5.png" alt="testimonials">
                            </div>
                            <div class="item-6">
                                <img src="frontend/assets/images/testimonials/user-6.png" alt="testimonials">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="testimonials-shape">
            <img src="frontend/assets/images/testimonials-shape.png" alt="">
        </div>
        <div class="testimonials-map">
            <img src="frontend/assets/images/testimonials-map.png" alt="">
        </div>
            ...
            <div class="row screenshot-active">
                <div class="col-lg-3">
                    <div class="screenshot-item">
                        <img src="frontend/assets/images/screenshot-1.jpg" alt="">
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="screenshot-item">
                        <img src="frontend/assets/images/screenshot-2.jpg" alt="">
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="screenshot-item">
                        <img src="frontend/assets/images/screenshot-3.jpg" alt="">
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="screenshot-item">
                        <img src="frontend/assets/images/screenshot-4.jpg" alt="">
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="screenshot-item">
                        <img src="frontend/assets/images/screenshot-5.jpg" alt="">
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="screenshot-item">
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="faq-content">
                        ...
                        <img src="frontend/assets/images/faq-thumb.jpg" alt="">
                    </div>
                </div>
                <div class="col-lg-7">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="footer-widget footer-widget-about">
                        <a href="#"><img src="/images/admin logo.png" alt="logo"></a>
